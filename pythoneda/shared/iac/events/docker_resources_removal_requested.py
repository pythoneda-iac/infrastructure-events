...
"""
pythoneda/shared/iac/events/docker_resources_removal_requested.py
...
class DockerResourcesRemovalRequested(AbstractDockerResourcesEvent):
    """
    Represents the moment Dockerresources removal is requested.

    Class name: DockerResourcesRemovalRequested
    ...
    def __init__(
        ...
        """
        Creates a new DockerResourcesRemovalRequested instance.
